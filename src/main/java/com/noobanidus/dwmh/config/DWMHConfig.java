...
public class DWMHConfig {
    ...
    public static class Ocarina {
        ...
        @Config.Comment("Options related to audio and text output of the Ocarina. While these affect the client, the values on the server will override anything on the client.")
